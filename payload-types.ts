...
export interface Post {
  ...
  title: string;
  /**
   * Short summary shown on cards and as the article deck.
   */
  excerpt?: string | null;
  body?: {
    root: {
  ...
  /**
   * Optional relative label (e.g. "2 hours ago").
   */
...
export interface Category {
  ...
  /**
   * Controls nav ordering (lower = earlier).
   */
  order?: number | null;
  updatedAt: string;
  createdAt: string;
...
export interface Author {
  ...
  slug: string;
  /**
   * e.g. Senior Compliance Reporter
   */
  role?: string | null;
  bio?: string | null;
  /**
   * Avatar fallback initials (e.g. SM).
   */
  initials?: string | null;
  avatar?: (number | null) | Media;
  /**
   * Named newsletter for this beat (e.g. Compliance Watch).
   */
  beat?: string | null;
  /**
...
export interface Tag {
  ...
  description?: string | null;
  /**
   * Optional display count shown on the tag page.
   */
